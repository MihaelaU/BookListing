...
/**
 * API This class provides a method for querying to Google Books API
 */
class API {
    private static final String LOG_TAG = API.class.getSimpleName();
    private static final String apiURI = "https://www.googleapis.com/books/v1/volumes?q=quilting";
     ...
     */
    public String callAPI(String searchCriteria) {
        ...
        try {
            ...
            queryURI = apiURI + querySearchCriteria;
